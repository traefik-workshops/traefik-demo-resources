...
module "otel_dns_gate" {
  source = "git::https://github.com/traefik-workshops/traefik-demo-resources.git//terraform/observability/dns-gate?ref=v8.0.0"
...
module "spoke_whoami" {
  source     = "...//terraform/apps/whoami/ec2?ref=v8.0.0"
