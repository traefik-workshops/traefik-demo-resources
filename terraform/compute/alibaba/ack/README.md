...
```hcl
module "vpc" {
  source = "git::https://github.com/traefik/traefik-demo.git//terraform/compute/alibaba/vpc?ref=v4.3.0"

  name = "traefik-demo"
}

module "ack" {
  source = "git::https://github.com/traefik/traefik-demo.git//terraform/compute/alibaba/ack?ref=v4.3.0"
