...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 5.1.0
```
...
|------|---------|------------|-----------|
| ai-gateway | `5.1.0` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `5.1.0` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `5.1.0` | `file://../keycloak` | `keycloak.enabled` |
