...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 8.1.0
```
...
|------|---------|------------|-----------|
| ai-gateway | `8.1.0` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `8.1.0` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `8.1.0` | `file://../keycloak` | `keycloak.enabled` |
