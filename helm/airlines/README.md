...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 6.1.5
```
...
|------|---------|------------|-----------|
| ai-gateway | `6.1.5` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `6.1.5` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `6.1.5` | `file://../keycloak` | `keycloak.enabled` |
