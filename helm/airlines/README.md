...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 5.4.2
```
...
|------|---------|------------|-----------|
| ai-gateway | `5.4.2` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `5.4.2` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `5.4.2` | `file://../keycloak` | `keycloak.enabled` |
