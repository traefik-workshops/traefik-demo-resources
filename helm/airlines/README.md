...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 5.0.1
```
...
|------|---------|------------|-----------|
| ai-gateway | `5.0.1` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `5.0.1` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `5.0.1` | `file://../keycloak` | `keycloak.enabled` |
