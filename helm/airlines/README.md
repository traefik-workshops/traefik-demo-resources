...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 7.0.0
```
...
|------|---------|------------|-----------|
| ai-gateway | `7.0.0` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `7.0.0` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `7.0.0` | `file://../keycloak` | `keycloak.enabled` |
