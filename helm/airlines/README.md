...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 6.2.8
```
...
|------|---------|------------|-----------|
| ai-gateway | `6.2.8` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `6.2.8` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `6.2.8` | `file://../keycloak` | `keycloak.enabled` |
