...
```bash
helm install my-airlines oci://ghcr.io/traefik-workshops/airlines --version 8.0.0
```
...
|------|---------|------------|-----------|
| ai-gateway | `8.0.0` | `file://../ai-gateway` | `aiGateway.enabled` |
| hoppscotch | `8.0.0` | `file://../hoppscotch` | `hoppscotch.enabled` |
| keycloak | `8.0.0` | `file://../keycloak` | `keycloak.enabled` |
