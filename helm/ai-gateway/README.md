...
- **Chart version:** `5.2.2` (slaved to the repo tag — see [`../AGENTS.md`](../AGENTS.md))
- **App version:** `1.0.0`

## Install

```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 5.2.2
```
...
|------|---------|------------|-----------|
| embeddings | `5.2.2` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `5.2.2` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
