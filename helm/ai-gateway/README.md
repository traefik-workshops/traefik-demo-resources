...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 5.0.1
```
...
|------|---------|------------|-----------|
| embeddings | `5.0.1` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `5.0.1` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
