...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 6.6.0
```
...
|------|---------|------------|-----------|
| embeddings | `6.6.0` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `6.6.0` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
