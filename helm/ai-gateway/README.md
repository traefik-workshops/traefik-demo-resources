...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 5.0.0
```
...
|------|---------|------------|-----------|
| embeddings | `5.0.0` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `5.0.0` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
