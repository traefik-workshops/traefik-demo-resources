...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 5.4.2
```
...
|------|---------|------------|-----------|
| embeddings | `5.4.2` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `5.4.2` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
