...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 6.2.8
```
...
|------|---------|------------|-----------|
| embeddings | `6.2.8` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `6.2.8` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
