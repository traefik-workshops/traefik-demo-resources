...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 6.1.2
```
...
|------|---------|------------|-----------|
| embeddings | `6.1.2` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `6.1.2` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
