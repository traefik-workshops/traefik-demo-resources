...
- **Chart version:** `6.1.0` (slaved to the repo tag — see [`../AGENTS.md`](../AGENTS.md))
- **App version:** `1.0.0`

## Install

```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 6.1.0
```
...
|------|---------|------------|-----------|
| embeddings | `6.1.0` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `6.1.0` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
