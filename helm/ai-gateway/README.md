...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 8.0.0
```
...
|------|---------|------------|-----------|
| embeddings | `8.0.0` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `8.0.0` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
