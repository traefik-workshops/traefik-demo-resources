...
```bash
helm install my-ai-gateway oci://ghcr.io/traefik-workshops/ai-gateway --version 6.1.3
```
...
|------|---------|------------|-----------|
| embeddings | `6.1.3` | `file://../embeddings` | `sharedMiddlewares.semanticCache.enabled` |
| presidio | `6.1.3` | `file://../presidio` | `sharedMiddlewares.contentGuardPresidio.enabled` |
